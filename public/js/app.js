...
var TitleRow = _interopRequire(require("./title-row"));

var TitleList = _interopRequire(require("./title-list"));
        ...
        render: {
            value: function render() {
                ...
                return React.createElement(
                    ...
                    React.createElement(TitleList, { titles: titleLists.mylist })
                );
            }
        },
        mapTitleLists: {
            ...
            value: function mapTitleLists(titleLists) {
                var html = [],
                    config = this.props.config;

                for (var id in titleLists) {
                    var titles = titleLists[id];
                    html.push(React.createElement(TitleRow, { name: config[id].name, titles: titles, action: config[id].action }));
                }
...
},{"./title-list":2,"./title-row":3,"react":164}],2:[function(require,module,exports){
"use strict";
...
var TitleList = (function (_React$Component) {
    function TitleList(props) {
        ...
        _get(Object.getPrototypeOf(TitleList.prototype), "constructor", this).call(this, props);
    ...
    _createClass(TitleList, {
        ...
        componentDidMount: {
            value: function componentDidMount() {
                ...
                this.unsubscribe = events.on("data.mylist", function (titles) {
        ...
        mapTitles: {
            ...
            value: function mapTitles(titles) {
...
},{"../events":7,"react":164}],3:[function(require,module,exports){
"use strict";
...
var Title = _interopRequire(require("./title"));

var events = _interopRequire(require("../events"));

var TitleRow = (function (_React$Component) {
    function TitleRow(props) {
        _classCallCheck(this, TitleRow);

        _get(Object.getPrototypeOf(TitleRow.prototype), "constructor", this).call(this, props);
        this.state = { titles: props.titles };
    }

    _inherits(TitleRow, _React$Component);
    ...
    _createClass(TitleRow, {
        ...
        mapTitles: {
            ...
            value: function mapTitles(titles) {
                ...
                return titles.map(function (title) {
                    return React.createElement(Title, { title: title, action: _this.props.action });
                });
            }
        }
    });
...
module.exports = TitleRow;

},{"../events":7,"./title":4,"react":164}],4:[function(require,module,exports){
"use strict";
        ...
        render: {
            value: function render() {
                return React.createElement(
                    "div",
                    { className: "title" },
                    React.createElement("img", { className: "title-image", src: this.props.title.img }),
                    React.createElement(
                        "span",
                        { className: "action", onClick: this.moveTitle.bind(this) },
                        " ",
                        this.props.action,
                        " "
                    )
...
},{"../events":7,"react":164}],5:[function(require,module,exports){
"use strict";
...
module.exports = {
    init: function () {
        events.on("title.Add", function (title) {
            var exists = data.mylist.some(function (t) {
        ...
        events.on("title.Remove", function (title) {
...
var titleLists = _interopRequire(require("./data/title-lists"));

var config = _interopRequire(require("./data/config"));

document.addEventListener("DOMContentLoaded", function () {
    titleLists.init();
    React.render(React.createElement(App, { titleLists: titleLists.read(), config: config }), document.body);
});

},{"./components/app":1,"./data/config":5,"./data/title-lists":6,"react":164}],9:[function(require,module,exports){
